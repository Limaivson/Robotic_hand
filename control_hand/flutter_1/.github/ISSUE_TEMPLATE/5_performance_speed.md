...
3.  Switch flutter_1 to master channel and run this app on a physical device
     using profile mode with Skia tracing enabled, as follows:
       flutter_1 channel master
       flutter_1 run --profile --trace-skia
...
<!-- Finally, paste the output of running `flutter_1 doctor -v` here, with your device plugged in. -->
