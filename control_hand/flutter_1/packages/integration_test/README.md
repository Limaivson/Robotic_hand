...
```bash
pushd android
# flutter_1 build generates files in android/ for building the app
flutter_1 build apk
...
```sh
flutter_1 build ios --config-only integration_test/foo_test.dart
```
...
flutter_1 build ios integration_test/foo_test.dart --release
