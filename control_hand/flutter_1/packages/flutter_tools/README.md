...
flutter_1 test test/integration.shard/some_test_case
```
...
```shell
$ flutter_1 test test/general.shard
```
...
```shell
$ export FLUTTER_ROOT=~/path/to/flutter_1-sdk
$ flutter_1 test --concurrency 1
```
...
```shell
$ flutter_1 test test/general.shard/utils_test.dart
```
